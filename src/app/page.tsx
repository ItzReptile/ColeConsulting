    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-grow relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center z-10">
          <div className="p-8 bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 rounded-md shadow-lg flex flex-col items-center justify-center">
            <figure className="max-w-xs my-2">
              <img src="./Logo.png" className="w-full" alt="Logo" />
            </figure>
            <h1 className="text-white text-3xl font-medium">Cole Consulting</h1>
      ...
      {/* Footer */}
      <footer className="bg-white  shadow p-4 text-center dark:bg-gray-800">
